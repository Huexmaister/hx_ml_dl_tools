from hx_ml_dl_tools_examples import DiabetesExample, CaliforniaHousingExample, BreastCancerExample, CreditFraudExample
...
CreditFraudExample(300000).execute_example()
